      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-4 right-4 left-4 sm:left-auto sm:right-6 sm:bottom-6 z-[100] sm:w-[400px] h-[500px] max-h-[80vh] flex flex-col bg-[#08070b] border border-white/10 rounded-2xl shadow-2xl overflow-hidden"
          >
            {/* Header */}
